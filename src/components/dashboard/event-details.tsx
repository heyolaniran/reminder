...
export default function EventDetails({ event, handleRemindPending, isLoadingStats, eventStats }: { event: { start: string, end: string, location: string, htmlLink: string, summary: string }, handleRemindPending: () => void, isLoadingStats: boolean, eventStats: { accepted: { count: number, emails: string[] }, tentative: { count: number, emails: string[] }, declined: { count: number, emails: string[] }, needsAction: { count: number, emails: string[] } } }) {
